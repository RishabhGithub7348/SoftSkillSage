...
import { scene9, scene10, scene11 } from '../assets'
...
const Problem9 = () => {
  ...
  const images = [scene9, scene10, scene11]
  const timeouts = [3000, 5000, 7000]
  ...
  const handleOptionChange = async (value) => {
    ...
    try {
      if (value === 'lust') {
        const response = await axios.patch('/empathy/' + user.id, {
          empathyScore: 1,
        })
        navigate('/problem10')
      }
      ...
      if (value === 'crush') {
        ...
        const response1 = await axios.patch('/curiosity/' + user.id, {
          curiosityScore: 1,
        })
                  ...
                  <div className='col-span-5'>
                    ...
                    >
                      ...
                      <Radio value='crush' color='success' labelColor='success'>
                        <p className='text-white text-xl ml-3 font-semibold'>
                          Console her and ask few questions
                        </p>
                      </Radio>
                    </Radio.Group>
                  </div>
