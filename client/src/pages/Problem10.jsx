...
import { scene12, scene13, scene14, backdrop } from '../assets'
...
const Problem10 = () => {
  ...
  const images = [scene12, scene13, scene14, backdrop]
              ...
              <div className='flex p-2 items-center w-full justify-center h-12 mt-4 border-2  bg-[#111827]  rounded-md'>
                <div className='flex-none items-center justify-center'>
                  <p className='text-[#e2e8f0]'>
                    What can you predict from the Desktop , about the victims
                    profession
                  </p>
                </div>
              </div>
                ...
                <>
                  <div className='col-span-5'>
                    ...
                    >
                      ...
                      >
                        <p className='text-white text-xl ml-3 font-semibold'>
                          A programmer who works for an MNC
                        </p>
                      </Radio>
                    </Radio.Group>
                  </div>
